...
#define memcpy_symbol					0x8000000000083098 // Confirmed
#define peek_symbol					0x800000000000170cULL // Confirmed

static inline void memcpy_internal(void *str1, const void *str2, uint64_t n)
{
	lv2syscall3_sc10_15(15, (uint64_t)str1, (uint64_t)str2, n, memcpy_symbol);
}
